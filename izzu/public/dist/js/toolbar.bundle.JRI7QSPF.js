(() => {
  // frappe-html:/home/ali/bench-14/apps/izzu/izzu/public/js/ui/toolbar/navbar.html
  frappe.templates["navbar"] = `<header class="navbar navbar-expand sticky-top" role="navigation" style="background-color: white;">
    <div class="container" >
      <a class="navbar-brand navbar-home" href="/app" id="navbar-logo">
        <img
          class="app-logo"
          style="width: {{ navbar_settings.logo_width || 60 }}px"
          src="/assets/azgard9_ui/images/az-logo.svg"
        />
      </a>
            ...
            >
              <span class="notifications-seen">
                <svg class="icon icon-md">
                  <use href="#icon-notification" style="fill:white"></use>
                </svg>
              </span>
  ...
  // ../izzu/izzu/public/js/ui/toolbar/issue-report.js
...
//# sourceMappingURL=toolbar.bundle.JRI7QSPF.js.map
